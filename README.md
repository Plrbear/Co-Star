# Co-STAR: Collaborative Curriculum Self-Training with Adaptive Regularization for Source-Free Video Domain Adaptation (WACV 2026)
...
- In the paper, one of the CLIP backbones is mistakenly written as **ViT-B/14**. The released implementation uses **ViT-L/14**. The transformer results were included as an additional evaluation alongside **ResNet50**, rather than as a direct same-backbone comparison with prior **ViT-B/14** methods.
